...
class TestQgisDocsLoadingLayers(unittest.TestCase):
    ...
    def test_qgisdocs_loaddxflayer(self):
        pass

    @unittest.skip("unit test case (sic!) not implemented yet")
    def test_qgisdocs_mockdatasource(self):
        pass

    @unittest.skip("unit test case (sic!) not implemented yet")
    def test_qgisdocs_loadrasterlayer(self):
        pass

    @unittest.skip("unit test case (sic!) not implemented yet")
    def test_qgisdocs_getlistoflayers(self):
        pass
