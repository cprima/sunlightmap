...
class TestQgisDocsMapRenderingAndPrinting(unittest.TestCase):
    ...
    def test_qgisdocs_simplerendering(self):
        pass

    @unittest.skip("unit test case (sic!) not implemented yet")
    def test_qgisdocs_renderinglayerswithdifferentcrs(self):
        pass
